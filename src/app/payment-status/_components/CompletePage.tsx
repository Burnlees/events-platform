...
export default function CompletePage() {
  ...
  return (
    <div id="payment-status" className="flex flex-col gap-4">
      <div
        id="status-icon"
      ...
      <div className="flex justify-between">
        {intentId && (
          <Link href={`https://dashboard.stripe.com/payments/${intentId}`}>
            <Button size={"sm"} id="view-details">
              View Details
            </Button>
          </Link>
        )}
        <Link href={"/"}>
          <Button size={"sm"} id="home-button">
            Back To Home
          </Button>
        </Link>
      </div>
